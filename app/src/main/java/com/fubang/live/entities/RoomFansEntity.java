 ...
 */
public class RoomFansEntity implements Parcelable {


    /**
     * status : success
     * datalist : [{"roomid":"175495572","roomname":"175495572","roompic":"","roomrs":"300","roompwd":"","rscount":"0","gateway":"121.40.140.100:10744;121.40.140.100:10744;121.40.140.100:10744","ctheme":"","nuserid":"175495572","cphoto":"20170425020503_729.jpg","bphoto":"20170425020503_297.jpg","calias":"小丸子","cidiograph":"人人好 大家好","guanzhunum":"1","state":"2","ngender":"1"}]
     */
    ...
    public RoomFansEntity() {
    }

    protected RoomFansEntity(Parcel in) {
        this.status = in.readString();
        this.datalist = new ArrayList<DatalistBean>();
        in.readList(this.datalist, DatalistBean.class.getClassLoader());
    }

    public static final Parcelable.Creator<RoomFansEntity> CREATOR = new Parcelable.Creator<RoomFansEntity>() {
        @Override
        public RoomFansEntity createFromParcel(Parcel source) {
            return new RoomFansEntity(source);
        }

        @Override
        public RoomFansEntity[] newArray(int size) {
            return new RoomFansEntity[size];
        }
    };
}
