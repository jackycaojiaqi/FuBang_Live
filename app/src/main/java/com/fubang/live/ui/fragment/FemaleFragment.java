 ...
 */
public class FemaleFragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private void initview() {
        ...
        if (listBeen.size() > 0) {
            ...
            banner.setImageLoader(new FemaleFragment.GlideImageLoader());
            //设置图片集合
