 ...
 */
public class UserFavAdapter extends BaseItemDraggableAdapter<RoomFavEntity.DatalistBean, BaseViewHolder> {
    private List<RoomFavEntity.DatalistBean> list;

    public UserFavAdapter(int layoutResId, List data) {
        super(layoutResId, data);
        list = data;
    }

    @Override
    protected void convert(BaseViewHolder helper, RoomFavEntity.DatalistBean item) {
